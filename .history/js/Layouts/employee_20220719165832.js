class EmployeePage {
    ...
    initEventFilter() {
        ...
        me.grid.attr("Show_option").find("[option_Name]").off("change");
        me.grid.attr("Show_option").find("[option_Name]").on("change", function() {
            me.getData();
        });
    }
    ...
    getData() {
        ...
        let data = CommonFn.Ajax(me.Url + "?pageSize=" + pageSize + "&pageNumber=" + pageNumber + "&DepartmentID=" + departmentID + "&PositionID=" + positionID, 
