class FormNewEmployee {
    ...
    open(param) {
        ...
        // // Nếu nhân bản nhân viên
        // if(param && param.formMode === resources.CommandType.Replication) {
        // }
    }
    ...
    resetFormUpdate(data) {
        ...
        me.form.find("[setField]").each(function() {
            ...
            if(setFeild === "phoneNumber") {
                data[setFeild] = "0" + data[setFeild].slice(5).trim();
            }
            else if(setFeild === "dateOfBirth") {
                data[setFeild] = CommonFn.formatDateInput(data[setFeild]);
            }
