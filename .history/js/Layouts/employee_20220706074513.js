class Employee {
    constructor (gridID, collabID) {
        ...
        // Khởi tạo biến chứa columnCofig
    ...
    getColumnConfig() {
        ...
        me.grid.find(".col").each(function(item) {
            ...
            Object.keys(columnDefault).filter(function(keyName) {
                let value = that.attr(keyName);
    ...
    renderth() {
        ...
        me.columnConfig.filter(function(item) {
            let text = item.Text;
                dataType = item.DSataType,
                th = $("<th></th>");
