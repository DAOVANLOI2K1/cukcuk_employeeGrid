class EmployeePage {
    ...
    getData(show_option) {
        ...
        if(departmentID && positionID) {
            text = "?PositionID=\"" + positionID + "\"&DepartmentID=\"" + departmentID + "\"";
        }
        else {
            text = "?PositionID=null&DepartmentID=null";
        }

        let data = CommonFn.Ajax(me.Url + text + "&pageSize=" + pageSize + "&pageNumber=" + pageNumber, 
